...
plain_text= int("Roma è la citta più bella del mondo".encode("utf-8").hex(), 16)
#messaggio già convertito in hex

cifrato= pow(plain_text, 3, modulo)
...
messaggio_decifrato = pow(int(cifrato), priv_exponent, modulo) # decifro il messaggio con esponente privato e modulo
